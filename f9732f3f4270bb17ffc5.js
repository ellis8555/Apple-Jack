...
function setPlayersBoxscoreTable(e, {thisGamesPlayerStatMAPS, thisGamesHomeTeamPlayerNames, thisGamesHomeTeamColor, thisGamesAwayTeamColor}) {
  ...
  if (e) {
    ...
    const thead = helpers_boxscorePlayersTableHeadersElements(SINGLE_GAME_PLAYERS_TABLE, sortBy)
    table.append(thead)
    const tableBody = document.createElement('tbody');
    const td = helpers_boxscorePlayersTableDataElements(thisGamesPlayerStatMAPS, SINGLE_GAME_PLAYERS_TABLE, thisGamesHomeTeamPlayerNames, thisGamesHomeTeamColor, thisGamesAwayTeamColor, sortBy)
    tableBody.append(td)
...
/******/ })()
;
//# sourceMappingURL=f9732f3f4270bb17ffc5.js.map