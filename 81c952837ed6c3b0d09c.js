...
const vars_DEFENDING_CHAMPS = "Degeneration Hax";
...
function playoffTree(seasonNumber){
    ...
    setHeaderBanner_setHeaderBanner(CHAMPIONS_LIST[championsListElement], seasonNumber == season_currentSeason ? (IN_BETWEEN_SEASONS ? seasonNumber : seasonNumber-1) : seasonNumber)
...
function setSeasonsFullTable(seasonNumber = season_currentSeason, modeDescriptor = "Season", tableDescriptor = "Regular Season") {
  setHeaderBanner_setHeaderBanner(vars_DEFENDING_CHAMPS, IN_BETWEEN_SEASONS ? season_currentSeason : season_currentSeason-1)
  setMainNavbar_setMainNavbar(seasonNumber);
...
/******/ })()
;
//# sourceMappingURL=81c952837ed6c3b0d09c.js.map