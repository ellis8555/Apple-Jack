...
///////////////////////////////FUNCTION DUPLICATE NEEDED FOR SCREEN RESIZE////////////////////////////////

export function getTeamsPlayersPerSeasonResized(
  teamsName,
  seasonNumber,
  teamLogo
) {
  clearTablesDiv();
  clearScoreboardDiv();
  let team = teamsNumMAP.get(teamsName);
  let teamName = teamsName;
  let teamColor = `#${eachTeamObjectMAP.get(teamsMAP.get(team)).MainColor}`;
  let seasonNum = seasonNumber;
  let teamImage = teamLogo; // used for the back button
